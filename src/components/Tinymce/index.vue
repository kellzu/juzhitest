...
const plugins = [
  ...
  spellchecker tabfocus table template textcolor textpattern visualblocks visualchars wordcount imagetools`
];
const toolbar = [
  `bold italic underline strikethrough alignleft aligncenter alignjustify
  alignright outdent indent  blockquote undo redo removeformat`,
  `hr bullist numlist link image imagetools charmap	 preview anchor pagebreak
